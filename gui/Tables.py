...
class Process_Data_Tables(QtWidgets.QMainWindow):
    ...
    def exec_process(self, original_df):
        ...
        if original_df is not None:
            ...
            brands = ["0", "30", "60", "90", "120", "150", "180", "210", "prechurn", "potencial", "castigo", "churn", "preprovision", "prepotencial", "provision"]
    ...
    def process_to_exec(self):
        ...
        if lenght_list >= 8:
            ...
            elif "Todo - Castigo" in brands:
                brands = ["0", "30", "60", "90", "120", "150", "180", "210", "prechurn", "potencial", "churn", "preprovision", "prepotencial", "provision"]
