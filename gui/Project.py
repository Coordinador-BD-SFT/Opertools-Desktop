...
import modules.BOT_Process_Pash
import modules.IVR_Process_Pash
...
class Process_Data(QtWidgets.QMainWindow):
    ...
    def exec_process(self):
        ...
        self.process_data.pushButton_Partitions_BD_38.clicked.connect(self.reorder_phones)
    ...
    def compilation_process_direction(self):
        ...
        if lenght_list >= 8:        
            ...
            modules.TASK_Web.Function_Complete(file, root, partitions, brands, origins, date, benefits, contact, \
                                                    value_min, value_max)
            Mbox_In_Process = QMessageBox()
            Mbox_In_Process.setWindowTitle("")
            Mbox_In_Process.setIcon(QMessageBox.Icon.Information)
