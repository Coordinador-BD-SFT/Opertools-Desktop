...
def Function_Complete(path, output_directory, partitions, filter_brands, filter_origins, Dates, Benefits, Contacts_Min, Value_Min, Value_Max):
    ...
    Data_Frame = Task_Process(Data_Frame, output_directory, partitions, filter_brands, filter_origins, \
                             Dates, Benefits, Contacts_Min, Value_Min, Value_Max)
...
def Renamed_Column(Data_Frame):
    ...
    Data_Frame = Data_Frame.select("Telefono 1", "Telefono 2", "Telefono 3", "**", \
                                   "Documento", "CRM Origen", "**2", "Cuenta", "Marca", \
                                    "DIAS DE MORA", "DESCUENTO", "Tipo de Linea")
...
def Task_Process(Data_, Directory_to_Save, partitions, filter_brands, filter_origins, Dates, today_IVR, Benefits, Contacts_Min, Value_Min, Value_Max):
    ...
    Data_ = Data_.select("Dato_Contacto", "Telefono 2", "Telefono 3", "**", "identificacion", "origen", "**2", "cuenta", \
                         ...
                         "descuento", "tipo_pago", "nombrecompleto")
